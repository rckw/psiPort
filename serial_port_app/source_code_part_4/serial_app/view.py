...
from .app_widgets import SerialMenuBar, SerialToolBar, SerialBox
...
class SerialWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        # Set the serial box defined in the app_widgets module.
    ...
    def _layout(self):
        self.window_layout.addWidget(self.serial_box)
